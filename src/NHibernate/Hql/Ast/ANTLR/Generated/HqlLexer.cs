...
// $ANTLR 3.5.0.2 Hql.g 2017-07-15 14:31:15
...
public partial class HqlLexer : Antlr.Runtime.Lexer
{
	...
	private void mIDENT()
	{
		...
		try
		{
			int _type = IDENT;
			int _channel = DefaultTokenChannel;
			// Hql.g:727:2: ( ID_START_LETTER ( ID_LETTER )* )
			DebugEnterAlt(1);
			// Hql.g:727:4: ID_START_LETTER ( ID_LETTER )*
			{
			DebugLocation(727, 4);
			mID_START_LETTER(); if (state.failed) return;
			DebugLocation(727, 20);
			// Hql.g:727:20: ( ID_LETTER )*
	...
	private void mID_LETTER()
	{
		...
		try
		{
			// Hql.g:742:5: ( ID_START_LETTER | '0' .. '9' )
			DebugEnterAlt(1);
			// Hql.g:
			{
			DebugLocation(742, 5);
	...
	private void mQUOTED_String()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Hql.g:746:4: ( '\\'' ( ( ESCqs )=> ESCqs |~ '\\'' )* '\\'' )
			DebugEnterAlt(1);
			// Hql.g:746:6: '\\'' ( ( ESCqs )=> ESCqs |~ '\\'' )* '\\''
			{
			DebugLocation(746, 6);
			Match('\''); if (state.failed) return;
			DebugLocation(746, 11);
			// Hql.g:746:11: ( ( ESCqs )=> ESCqs |~ '\\'' )*
	...
	private void mNUM_INT()
	{
		...
		try
		{
			...
			// Hql.g:768:2: ( '.' ( ( '0' .. '9' )+ ( EXPONENT )? (f1= FLOAT_SUFFIX )? )? | ( '0' ( ( 'x' ) ( HEX_DIGIT )+ | ( '0' .. '7' )+ )? | ( '1' .. '9' ) ( '0' .. '9' )* ) ( ( 'l' ) |{...}? ( '.' ( '0' .. '9' )* ( EXPONENT )? (f2= FLOAT_SUFFIX )? | EXPONENT (f3= FLOAT_SUFFIX )? |f4= FLOAT_SUFFIX ) )? )
			int alt20=2;
			...
			case 1:
				DebugEnterAlt(1);
				// Hql.g:768:6: '.' ( ( '0' .. '9' )+ ( EXPONENT )? (f1= FLOAT_SUFFIX )? )?
				{
				DebugLocation(768, 6);
				Match('.'); if (state.failed) return;
				...
				DebugLocation(769, 4);
				// Hql.g:769:4: ( ( '0' .. '9' )+ ( EXPONENT )? (f1= FLOAT_SUFFIX )? )?
				int alt8=2;
				...
				case 1:
					...
					DebugLocation(769, 30);
					// Hql.g:769:30: (f1= FLOAT_SUFFIX )?
					int alt7=2;
					...
					case 1:
						DebugEnterAlt(1);
						// Hql.g:769:31: f1= FLOAT_SUFFIX
						{
						DebugLocation(769, 33);
			...
			case 2:
				DebugEnterAlt(2);
				// Hql.g:785:4: ( '0' ( ( 'x' ) ( HEX_DIGIT )+ | ( '0' .. '7' )+ )? | ( '1' .. '9' ) ( '0' .. '9' )* ) ( ( 'l' ) |{...}? ( '.' ( '0' .. '9' )* ( EXPONENT )? (f2= FLOAT_SUFFIX )? | EXPONENT (f3= FLOAT_SUFFIX )? |f4= FLOAT_SUFFIX ) )?
				{
				DebugLocation(785, 4);
				// Hql.g:785:4: ( '0' ( ( 'x' ) ( HEX_DIGIT )+ | ( '0' .. '7' )+ )? | ( '1' .. '9' ) ( '0' .. '9' )* )
				int alt13=2;
				...
				DebugLocation(800, 3);
				// Hql.g:800:3: ( ( 'l' ) |{...}? ( '.' ( '0' .. '9' )* ( EXPONENT )? (f2= FLOAT_SUFFIX )? | EXPONENT (f3= FLOAT_SUFFIX )? |f4= FLOAT_SUFFIX ) )?
				int alt19=3;
				...
				case 2:
					DebugEnterAlt(2);
					// Hql.g:803:5: {...}? ( '.' ( '0' .. '9' )* ( EXPONENT )? (f2= FLOAT_SUFFIX )? | EXPONENT (f3= FLOAT_SUFFIX )? |f4= FLOAT_SUFFIX )
					{
					DebugLocation(803, 5);
					if (!((isDecimal)))
					{
					...
					DebugLocation(804, 4);
					// Hql.g:804:4: ( '.' ( '0' .. '9' )* ( EXPONENT )? (f2= FLOAT_SUFFIX )? | EXPONENT (f3= FLOAT_SUFFIX )? |f4= FLOAT_SUFFIX )
					int alt18=3;
					...
					case 1:
						DebugEnterAlt(1);
						// Hql.g:804:8: '.' ( '0' .. '9' )* ( EXPONENT )? (f2= FLOAT_SUFFIX )?
						{
						DebugLocation(804, 8);
						Match('.'); if (state.failed) return;
						...
						DebugLocation(804, 24);
						// Hql.g:804:24: ( EXPONENT )?
						int alt15=2;
					...
					case 2:
						DebugEnterAlt(2);
						// Hql.g:805:8: EXPONENT (f3= FLOAT_SUFFIX )?
						{
						DebugLocation(805, 8);
						mEXPONENT(); if (state.failed) return;
						DebugLocation(805, 17);
						// Hql.g:805:17: (f3= FLOAT_SUFFIX )?
						int alt17=2;
						...
						case 1:
							DebugEnterAlt(1);
							// Hql.g:805:18: f3= FLOAT_SUFFIX
							{
							DebugLocation(805, 20);
